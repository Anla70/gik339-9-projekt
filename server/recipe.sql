...
INSERT INTO recipe (id, recipeName, recipeDescription, recipeIngredients, recipeInstructions, recipeColor) VALUES (1,'Kokt ägg','Varmrätt','Ägg ,vatten och salt', 'Koka ägget i 8 min');

INSERT INTO recipe (id, recipeName, recipeDescription, recipeIngredients, recipeInstructions, ) VALUES (2,'Köttbullar med mos','Varmrätt','1½dl mjölk, 5msk ströbröd, 500g Köttfärs, ½ gul lök, 1 ägg, 1krm peppar, 1tsk salt, ½tsk socker, smör eller margarin, Potatis, mjölk', 'Gör så här: Blanda mjölk och ströbröd. Låt svälla i 10 minuter. Tillsätt färs, lök, ägg, salt, peppar och socker i ströbrödsblandningen. Arbeta ihop färsen ordentligt. Fukta händerna med kallt vatten och forma köttbullar. Stek några i taget i matfett, skaka pannan då och då så att köttbullarna rullar runt och håller sig runda. Skala potatis och koka den. När de är färdigkokta, tillsätt mjölk och lite salt och mosa potatisarna till en jämn yta');
...
INSERT INTO recipe (id,recipeName, recipeDescription, recipeIngredients, recipeInstructions, ) VALUES (4,'Crepes med räkfyllning','Förrätt','Vetmjöl, Salt, Mjölk, Ägg, Smör, Fyllning: Skalade räkor, Purjolök, Creme Fraiche, Citron, Finhackad färsk dill, Riven prästost', 'Gör så hör: Vispa samman mjöl och salt med häften av mjölken till en jämn smet. Vispa i resten av mjölken och äggen. Smält smöret och rör ner det i smeten. Hacka purjolök fint. Blanda samman ingredienserna till fyllningen. Ställ åt sidan. Stek 8 stora eller 16 små pannkakor. Sätt ugnen på 225°. Låt svalna. Fördela fyllningen på pannkakorna, rulla ihop och lägg dem i en ugnssäker form. Strö över osten och gratinera i övre delen av ugnen ca 10 min.');
